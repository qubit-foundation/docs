...
<CardGroup cols={3}>
  <Card title="Data Foundation" icon="database" href="/layer-1/getting-started">
    Deploy your first connector in minutes
  </Card>
  <Card title="AI Forecasting" icon="chart-line" href="/layer-2/getting-started">
    Generate energy predictions with ML models
  </Card>
  <Card title="Optimization" icon="bolt" href="/layer-3/getting-started">
    Optimize EV charging and battery dispatch
  </Card>
  <Card title="Coordination" icon="paper-plane" href="/layer-4/getting-started">
